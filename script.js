...
// ===== ARSH MODAL HANDLING =====
function initArshModal() {
   const arshBadge = document.getElementById('arshBadge');
   const arshModal = document.getElementById('arshModal');
   const arshModalClose = document.getElementById('arshModalClose');
   const arshModalOverlay = document.getElementById('arshModalOverlay');

   // Open modal when badge is clicked
   arshBadge.addEventListener('click', () => {
      arshModal.classList.add('active');
      document.body.style.overflow = 'hidden';
   });

   // Close modal when close button is clicked
   arshModalClose.addEventListener('click', () => {
      arshModal.classList.remove('active');
      document.body.style.overflow = 'auto';
   });

   // Close modal when overlay is clicked
   arshModalOverlay.addEventListener('click', () => {
      arshModal.classList.remove('active');
      document.body.style.overflow = 'auto';
   });
   ...
   document.addEventListener('keydown', (e) => {
      if (e.key === 'Escape' && arshModal.classList.contains('active')) {
         arshModal.classList.remove('active');
         document.body.style.overflow = 'auto';
      }
   });
